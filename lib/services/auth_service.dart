...
class MyClient extends OAuth2Client {
  MyClient({required String redirectUri, required String customUriScheme}): super(
    authorizeUrl: 'https://api.intra.42.fr/oauth/authorize', //Your service's authorization url
    tokenUrl: 'https://api.intra.42.fr/oauth/token', //Your service access token url
...
final client = MyClient( redirectUri:'com.example.app', customUriScheme: 'com.example.app');
...
AccessTokenResponse tknResp = await client.getTokenWithClientCredentialsFlow(
	clientId: '99d29e146f98b61033acb008b5e121c9ce157eb1e23bead0905ad39fa0f9e2de', //Your client id
